...
const Chatbot = () => {
  ...
  return (
    <>
      <div className={`w-[100%] h-[100lvh] bg-gradient-to-r from-[#0B1E47] via-[#000000] to-[#0C2A6B]
 relative flex justify-center ${show ? '' : 'items-center'} py-5`}>

        {show  ? (
          <div className='overflow-y-auto w-full max-h-[70lvh] flex flex-col gap-5 px-10'>
        ...
        <textarea type="text" value={ques} onChange={(e) => setQues(e.target.value)} ref={inputref} className='w-[95%] pr-25 break-words bg-[#0A192F] text-white absolute bottom-5 px-5 text-2xl pt-3 rounded-2xl outline-none border border-blue-500 shadow-[0px_0px_10px_#1E40AF] h-28 resize-none' placeholder='Enter Your Prompt Here...' onKeyDown={handlekeydown}/>
